...
/* ADDING CUSTOM SMS PARAMETERS SYSTEM */
MessageSms.prototype.param1 = function (param) {
    return this.param('param1', param)
}
MessageSms.prototype.param2 = function (param) {
    return this.param('param2', param)
}
MessageSms.prototype.param3 = function (param) {
    return this.param('param3', param)
}
MessageSms.prototype.param4 = function (param) {
    return this.param('param4', param)
}
/* .ADDING CUSTOM SMS PARAMETERS SYSTEM */
